...
class Optional<T> extends IterableBase<T> {
  ...
  Optional.of(final T value) : _value = value {
  ...
  const Optional.fromNullable(final T? value) : _value = value;
  ...
  void ifPresent(final void Function(T value) ifPresent) {
    if (isPresent) {
      ifPresent(_value!);
    }
  }
  ...
  void ifAbsent(final void Function() ifAbsent) {
    if (!isPresent) {
      ifAbsent();
    }
  }
  ...
  T or(final T defaultValue) => _value ?? defaultValue;
  ...
  Optional<S> transform<S>(final S Function(T value) transformer) =>
      _value == null ? Optional<S>.absent() : Optional<S>.of(transformer(_value));
  ...
  Optional<S> transformNullable<S>(final S? Function(T value) transformer) =>
      _value == null ? Optional<S>.absent() : Optional<S>.fromNullable(transformer(_value));

  @override
  Iterator<T> get iterator => isPresent ? <T>[_value!].iterator : Iterable<T>.empty().iterator;
  ...
  @override
  bool operator ==(final Object o) => o is Optional<T> && o._value == _value;

  @override
  String toString() => _value == null ? 'Optional { absent }' : 'Optional { value: $_value }';
}
