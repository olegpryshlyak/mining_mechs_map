...
// Validator copied from
// https://github.com/fredeil/email-validator.dart/blob/master/lib/email_validator.dart

/// The Type enum
///
/// The domain type is either None, Alphabetic or Numeric
enum SubdomainType { none, alphabetic, numeric }
...
class EmailValidator {
  ...
  static bool _isDigit(final String c) => c.codeUnitAt(0) >= 48 && c.codeUnitAt(0) <= 57;
  ...
  // otherwise return false
  static bool _isLetter(final String c) =>
      (c.codeUnitAt(0) >= 65 && c.codeUnitAt(0) <= 90) || (c.codeUnitAt(0) >= 97 && c.codeUnitAt(0) <= 122);
  ...
  static bool _isLetterOrDigit(final String c) => _isLetter(c) || _isDigit(c);

  // Returns true if the first letter in the string c isnt a
  ...
  // returns false
  static bool _isAtom(final String c) =>
      c.codeUnitAt(0) < 128 ? _isLetterOrDigit(c) || _atomCharacters.contains(c) : true;
  ...
  // DomainType is set to Alphabetic and the function returns true
  static bool _isDomain(final String c) {
  ...
  static bool _isDomainStart(final String c) {
    if (c.codeUnitAt(0) < 128) {
      if (_isLetter(c)) {
        _domainType = SubdomainType.alphabetic;
        return true;
  ...
  static bool _skipAtom(final String text) {
  ...
  static bool _skipSubDomain(final String text) {
    final startIndex = _index;
  ...
  static bool _skipDomain(final String text) {
  ...
  // otherwise the function returns false
  static bool _skipQuoted(final String text) {
    var escaped = false;
  ...
  // TODO: Documentation for this function is required
  static bool _skipIPv4Literal(final String text) {
    var groups = 0;
  ...
  // otherwise, the function returns false
  static bool _isHexDigit(final String str) {
  ...
  static bool _skipIPv6Literal(final String text) {
    var compact = false;
    var colons = 0;
  ...
  static bool validate(final String email) {
    _index = 0;
